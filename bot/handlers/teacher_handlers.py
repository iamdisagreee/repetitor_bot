...
from bot.database import Student, LessonWeek
from bot.database.teacher_requests import command_add_teacher, command_add_lesson_week, give_installed_lessons_week, \
...
from bot.filters.teacher_filters import IsTeacherInDatabase, \
...
from bot.fsm.fsm_teacher import FSMRegistrationTeacherForm, FSMRegistrationLessonWeek, FSMAddStudentToStudy, \
...
from bot.keyboards.teacher_kb import create_entrance_kb, create_back_to_entrance_kb, create_authorization_kb, \
...
from bot.services.services import give_list_with_days, give_time_format_fsm, give_date_format_fsm, \
...
from bot.services.services_taskiq import delete_all_schedules_teacher
